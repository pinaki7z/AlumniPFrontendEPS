...
const IntJobs = (props) => {
    ...
    return (
        <>  <div className="jobs-page" style={{ margin: '0 5%', borderRadius: '12px', marginTop: '2%' }}>
            <div className="jobs-title">
                <p>Internships</p>
                <p>Search, find and apply to internships opportunities at Alumni Portal</p>
                        ...
                        <div className="card-body">
                            <Form>
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Control type="text" onChange={(e) => handleSearchChange(e, e.target.value, 'text')} placeholder={`Search for internships`} />
                                </Form.Group>
                            </Form>
